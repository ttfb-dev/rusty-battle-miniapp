...
export const HelpPanel = ({ id }) => {
  ...
  return (
    <Panel id={id} header={<PanelHeader separator={false}>Правила</PanelHeader>}>
      <Div>
        <CardGrid size="l">
            <ContentCard
      ...
      <Button stretched size="l" className="HelpPanel__button_back" onClick={() => {pushPanel(EPanels.START_GAME)}}>Понятно</Button>
    </Panel>
  )
}
